...
if($LinphoneActive -eq $null) {
	...
	packageName            = $env:ChocolateyPackageName
	fileType               = 'EXE'
	url                    = 'https://download.linphone.org/releases/windows/app/Linphone-4.4.0-win64.exe'
	checksum               = 'cc6184863346cbea801b471338f699c2097bf775326ee2df1a4caab26e22454c'
	checksumType           = 'sha256'
	silentArgs             = '/S'
	validExitCodes         = @(0)
	softwareName           = 'linphone'

...
if($LinphoneActive -eq $null) {
	...
	$packageArgsInstall = @{
		...
		fileType               = 'EXE'
		url                    = 'https://download.linphone.org/releases/windows/app/Linphone-5.3.2-win64.exe'
		checksum               = 'b8bc6ecc15069fa79114fb6cd0990c499d789d6230f79ad0530f6516c00de8a1'
  		checksumType           = 'sha256'
		silentArgs             = '/S'
		validExitCodes         = @(0)

...
if($LinphoneActive -eq $null) {
	...
	$packageArgsInstall = @{
		...
		fileType               = 'EXE'
		url                    = 'https://download.linphone.org/releases/windows/app/Linphone-5.2.4-win64.exe'
		checksum               = '237475d11f11eab30382292ecefc5734e2f87b7cc0553dea809a02114171e7f5'
  		checksumType           = 'sha256'
		silentArgs             = '/S'
		validExitCodes         = @(0)
